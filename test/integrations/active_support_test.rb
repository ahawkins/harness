...
class ActiveSupportIntegration < MiniTest::Unit::TestCase
  def test_logs_cache_read
    ...
    assert_increment "active_support.cache_read"
  end
  ...
  def test_logs_cache_generate
    ...
    assert_increment "active_support.cache_generate"
  end
  ...
  def test_logs_cache_fetch_hit
    ...
    assert_increment "active_support.cache_fetch_hit"
  end
  ...
  def test_logs_cache_write
    ...
    assert_increment "active_support.cache_write"
  end
  ...
  def test_logs_cache_delete
    ...
    assert_increment "active_support.cache_delete"
  end
